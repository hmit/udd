...
sth.execute
sth.fetch_all.each { |r| rc[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
sth = dbh.prepare("#{COMQ} #{NOPEND} and severity >= 'serious' #{ENDQ}")
sth.execute
sth.fetch_all.each { |r| rc_m[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
...
sth.execute
sth.fetch_all.each { |r| ino[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
sth = dbh.prepare("#{COMQ} #{NOPEND} and severity in ('important','normal') #{ENDQ}")
sth.execute
sth.fetch_all.each { |r| ino_m[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
...
sth.execute
sth.fetch_all.each { |r| mw[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
sth = dbh.prepare("#{COMQ} #{NOPEND} and severity in ('minor','wishlist') #{ENDQ}")
sth.execute
sth.fetch_all.each { |r| mw_m[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
...
sth.execute
sth.fetch_all.each { |r| fp[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
sth = dbh.prepare("#{COMQ} and bugs.id in (select id from bugs_tags where tag in ('pending','fixed')) #{ENDQ}")
sth.execute
sth.fetch_all.each { |r| fp_m[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
...
sth.execute
sth.fetch_all.each { |r| patch[r['source']] = r['cnt'] ; srcs[r['source']] = true }
sth.finish
