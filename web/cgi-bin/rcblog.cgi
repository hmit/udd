    ...
    <ul>
     <li><strong>Affecting jessie and unstable: <a href="http://udd.debian.org/bugs.cgi?release=jessie_and_sid&merged=ign&rc=1">#{jessie_sid}</a></strong>
      ...
      <ul>
       ...
       <li><strong><a href="http://udd.debian.org/bugs.cgi?release=jessie_and_sid&merged=ign&done=only&fnewerval=7&rc=1&sortby=id&sorto=asc&ctags=1&cdeferred=1">#{wh_done}</a> bugs are marked as done, but still affect unstable.</strong>
        This can happen due to missing builds on some architectures, for example. Help investigate!
       </li>
       <li><strong><a href="http://udd.debian.org/bugs.cgi?release=jessie_and_sid&patch=ign&merged=ign&done=ign&fnewerval=7&rc=1&sortby=id&sorto=asc&ctags=1&ctags=1&cdeferred=1">#{wh_neither}</a> bugs are neither tagged patch, nor marked done.</strong>
