...
from sources_uniq where distribution='debian' and release='jessie' and component='main' and (architecture ~ 'all' or architecture ~ 'any' or architecture ~ 'amd64') order by source")
sth.execute
