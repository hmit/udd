...
class sources_gatherer(gatherer):
  ...
  ignorable = {'Vcs-Arch': 0, 'Vcs-Bzr': 0,
      ...
      'Directory':0, 'Comment':0, 'Origin':0, 'Url':0, 'X-Collab-Maint':0, 'Autobuild':0, 'Vcs-Cvs:':0, 'Python-Standards-Version':0, 'url':0, 'originalmaintainer':0, 'Originalmaintainer':0, 'Build-Recommends':0, 'Maintainer-Homepage': 0, 'Python3-Version': 0, 'Package-List':0, 'Vcs-Upstream-Bzr':0, 'Testsuite':0, 'Apport':0}
